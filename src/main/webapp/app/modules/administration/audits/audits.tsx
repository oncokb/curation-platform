...
export interface IAuditsPageProps extends StoreProps, RouteComponentProps<{}> {}
...
const mapStoreToProps = (storeState: IRootStore) => ({
  audits: storeState.adminStore.audits,
  totalItems: storeState.adminStore.totalItems,
  getAudits: storeState.adminStore.getAudits,
});

type StoreProps = ReturnType<typeof mapStoreToProps>;

export default connect(mapStoreToProps)(AuditsPage);
